                        ...
                        <div className={`${Styles.formlg}`}>
                            ...
                            <div className={`${Styles.listtextfieldpass}`}>
                                <div className={`${Styles.eyeposition}`}>
                                    <span className={`${Styles.eyeclose}`} id='eyeClose'
                                    //  onClick={handleShowPassword}
                                     ><i className="fa-regular fa-eye-slash fa-flip-horizontal"></i></span>
                                    <span className={`${Styles.eyeopen}`} id='eyeOpen' 
                                    // onClick={handleClosePassword}
                                    ><i className="fa-regular fa-eye fa-flip-horizontal"></i></span>
                                </div>
                                <input className={`${Styles.textfieldlg}`} type="password" id="password" placeholder='Password' onChange={(e)=>{setPassword(e.target.value)}}/>
                            ...
                            <div className={`${Styles.listtextfieldpass}`}>
                                ...
                                <Button className={`${Styles.buttonlogin}`} variant="contained" type='submit' onClick={submit}>
                                    Đăng nhập
                                </Button>
                            </div>
                            <div className={`${Styles.listtextfieldpass}`}>
